...
import { FiDollarSign, FiTrendingUp, FiDownload, FiCalendar, FiAlertCircle } from 'react-icons/fi'
...
const Coins = () => {
  ...
  useEffect(() => {
    const loadCoinData = async () => {
      ...
      try {
        // Get user's current coin balance from authUser
        setBalance(authUser.coins || 0)
