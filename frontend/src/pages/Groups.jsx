                                  ...
                                  <div className="mb-4">
                                    ...
                                    <div className="flex items-center">
                                      {membersPreview.map((member, i) => (
                                        ...
                                        >
                                          <img
                                            src={member.user?.avatar || `https://api.dicebear.com/7.x/avataaars/svg?seed=${member.userId}`}
                                            alt={member.user?.name}
                                            className="w-8 h-8 rounded-full border-2 border-white ring-1 ring-gray-200 object-cover"
                                          />
                                          {member.isOnline && (
