  ...
  return (
    <div className="space-y-6">
      ...
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="flex items-end justify-between flex-wrap gap-4">
        <div>
          <h1 className="text-3xl font-bold !text-gray-900" style={{ color: '#111827' }}>Welcome back, {authUser?.name || authUser?.displayName || 'there'}! 👋</h1>
          <p className="mt-2 !text-gray-600" style={{ color: '#6B7280' }}>Here's your learning progress overview</p>
        </div>
      ...
      <Card>
        <div className="flex items-center justify-between mb-6">
          ...
          <Badge variant="primary">{earningOpportunities.filter((opportunity) => !opportunity.claimed).length} available</Badge>
        </div>
